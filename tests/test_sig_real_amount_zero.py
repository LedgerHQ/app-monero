...
from monero_client.monero_types import SigType, Keys, InsType
...
class TestSignatureRealAmountZero:
    ...
    @staticmethod
    def test_decoy1_prefix_hash_zero(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
    ...
    @staticmethod
    def test_decoy2_prefix_hash_zero(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
    ...
    @staticmethod
    def test_prefix_hash_zero(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
