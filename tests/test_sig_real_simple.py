...
class TestSignatureRealSimple:
    ...
    @staticmethod
    def test_decoy1_prefix_hash_2(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
    ...
    @staticmethod
    def test_decoy2_prefix_hash_2(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
    ...
    @staticmethod
    def test_prefix_hash_2(monero: MoneroCmd, navigator: Navigator, device: Device, test_name: str):
