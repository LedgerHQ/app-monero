...
void ui_menu_account_display(unsigned int value __attribute__((unused))) {
...
void ui_menu_network_display(unsigned int value __attribute__((unused))) {
...
void ui_menu_reset_display(unsigned int value __attribute__((unused))) {
...
void ui_menu_about_display(unsigned int value __attribute__((unused))) {
