...
.. |msk|    replace::  :math:`\mathcal{\mathrm{mask}`
.. |emask|  replace:: :math:`\widetilde{\mathcal{\mathrm{mask}}`
...
The application shall version is alowed
...
| 32     | public key |P|                                                  |
+--------+-----------------------------------------------------------------+
| 32     | encryped secret key |ex|                                        |
+--------+-----------------------------------------------------------------+
| 32     | encryped payment ID |ePayID|                                    |
+--------+-----------------------------------------------------------------+
...
If blind V2:
    | compute |msk| =
    | compute |s| = H("commitment_mask" \| |Akout|) % order
    | compute |s| = H("amount" \|  |Akout|)
...
| 01     | xx                                                              |
+--------+-----------------------------------------------------------------+
| 32     | encryped blinding factor |AKout|                                |
+--------+-----------------------------------------------------------------+
| 32     | blinded mask |ek|                                               |
+--------+-----------------------------------------------------------------+
| 32     | blinded amount |ev|                                             |
+--------+-----------------------------------------------------------------+
...
Finally the application receives the last part of data:
   ...
   |   update |mlsagH|:
   |   |s| = finalize |mlsagH|
   |   compute |mlsagH| = |H| (:math:`message` \| |s|  \| :math:`proof`)
   |
   | else
   |   update |ctH|': |Hupd|(|Ct|)
