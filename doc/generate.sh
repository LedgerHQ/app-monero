...
pandoc -s --template=blue-app-monero.template -f rst+raw_tex -t latex --toc -N -o blue-app-monero.pdf blue-app-monero.rst
#cp blue-app-monero.rst blue-app-monero.md
